...
defineOptions({ name: 'UiSectionTable' })
...
const paginatorDropdownStyle = {
  pcRowPerPageDropdown: {
    root: { class: 'p-select-sm p-inputfield-sm ml-10' },
    overlay: { class: 'p-select-overlay-sm' },
  },
}
...
const tablePt = {
  ...
  headerRow: { class: 'h-12' },
  headerCell: {
    class:
      'py-4 pr-8 pl-4 text-left first:rounded-tl-[10px] last:rounded-tr-[10px]',
  },
  bodyRow: { class: 'transition-colors' },
}
</script>

<template>
  <UiShowcaseTable title="Table">
    <div class="content">
