<script setup>
defineOptions({ name: 'UiSectionInputs' })

const inputState = ref({
  value: null,
  valueMask: null,
  error: { msg: 'Поле не должно быть пустым', show: true },
})

const inputOtp = ref({ value: null })
const errorHide = () => {
  ...
  <UiShowcaseTable
    ...
    <template #default-invalid>
      <div class="app-input">
        <InputText
          v-model="inputState.value"
          v-tooltip.top="{ value: inputState?.error?.msg, showDelay: 500 }"
